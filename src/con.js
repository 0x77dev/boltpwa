...
window.controller = {requestSession, androidKeycodeMenu, disableInteractions, emitHomeButton, enableInteractions, endSession, getScreenshot, heartbeat, openUrl, iframe, keypress, messageEventHandler, mouseclick, pasteText, restartApp, rotateLeft, rotateRight, saveScreenshot, setLanguage, setLocation, setScale, shakeDevice};
export {requestSession, androidKeycodeMenu, disableInteractions, emitHomeButton, enableInteractions, endSession, getScreenshot, heartbeat, openUrl, iframe, keypress, messageEventHandler, mouseclick, pasteText, restartApp, rotateLeft, rotateRight, saveScreenshot, setLanguage, setLocation, setScale, shakeDevice}